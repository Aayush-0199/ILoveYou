...
const SECTIONS = [
  ...
  { content: `Mla tujhi hich gosht far avadli ki tu breakup jhalyavar asa vicharach kela nahi ki relationship karel but serious nahi karnar and all that things .. But he as karna 100% right nahiye joparyant tu dusryala chance det nhi topryant tula samajnar nahi and this is the reality... and to be honest we both know that you will be in relationship one day. maybe not with me but with other guy and this is true.. So, majhi fakt ek gosht nit aikun ghe,  First of all tar tula mi adhi khup vela sangitlay ki mla tu 8 years pasun khup avadte you are  like childhood crush... But te sod ata... Ghadi ghadi tech tech sangel tar bore hoshil tu...  bagh adhich sangtoy ki he sarva tula impress karnyasathi nahi bolat aahe just telling you what's really true And I know ki he sarva sangitlyawar konatich mulgi impress hot nahi..  but mhatla let's keep it real and tell you what's true,  Who knows maybe it'll work...` },
  ...
  return (
    ...
    <div className="snap-container custom-scroll">
      ...
      <div className="snap-section">
        ...
        <div style={cardBaseStyles} className="flex flex-col items-center text-center gap-6 max-w-3xl w-full p-10 md:p-14 rounded-[3rem] relative">

          <img src={SHY_GIF_SRC} alt="Shy Bear" className="w-40 h-40 object-contain" />

          <div className="space-y-4 px-6">

            <h1 className="romantic-text text-5xl md:text-7xl font-black text-bright italic" style={{ color: BRIGHT_RED }}>Hii Sakshi</h1>
      ...
      {SECTIONS.map((sec, i) => (
        ...
        <div key={i} className="snap-section">
          ...
          <motion.div
            ...
            className="max-w-4xl w-full max-h-[85vh] p-8 md:p-14 rounded-[2.5rem] relative flex flex-col items-center justify-center"
          ...
          >
            ...
            <div className="relative w-full overflow-hidden flex flex-col items-center">
              ...
              <motion.div animate={{ y: [0, 5, 0] }} transition={{ repeat: Infinity, duration: 1.5 }} className="mt-4 flex flex-col items-center opacity-40 pointer-events-none">
                ...
                <ChevronDown size={24} style={{ color: BRIGHT_RED }} />
            ...
            <div className="absolute top-8 right-8"><Sparkles size={16} className="opacity-40" style={{ color: BRIGHT_RED }} /></div>
      ...
      <div className="snap-section">
        ...
        <button
          ...
          className="px-24 py-6 text-white rounded-2xl font-black shadow-lg transition-all active:scale-95 clean-font text-2xl uppercase tracking-[0.3em]"
    ...
    <div className="fixed inset-0 pointer-events-none overflow-hidden z-10">
      ...
      {hearts.map((h) => (
        ...
        <motion.div
          ...
          animate={{ bottom: `${h.endY}%`, left: `${h.endX}%`, opacity: [0, 0.9, 0.9, 0], scale: [0.5, 1.2, 1.2, 0.6], rotate: [0, 180, -180, 0] }}
...
export default function ProposalPage() {
  ...
  if (!mounted) return <div className="h-screen w-full bg-pink-50" />;
      ...
      <AnimatePresence mode="wait">
        ...
        {stage === "start" && (
          ...
          <motion.div key="start" className="h-screen flex flex-col items-center justify-center z-30 cursor-pointer" onClick={() => setStage("zoom")}>
            ...
            <motion.div animate={{ scale: [1, 1.1, 1] }} transition={{ repeat: Infinity, duration: 1.5 }}>
              ...
              <Heart size={150} fill={BRIGHT_RED} className="drop-shadow-[0_0_30px_rgba(255,0,0,0.5)]" style={{ color: BRIGHT_RED }} />

            </motion.div>

            <p className="mt-8 font-black text-2xl tracking-[0.4em] clean-font uppercase" style={{ color: BRIGHT_RED }}>Click Me</p>
        ...
        {stage === "zoom" && (
          ...
          <motion.div key="zoom" initial={{ scale: 1 }} animate={{ scale: 80, opacity: 0 }} transition={{ duration: 0.8 }} onAnimationComplete={() => setStage("mail")} className="h-screen flex items-center justify-center z-50">
            ...
            <Heart size={150} fill={BRIGHT_RED} style={{ color: BRIGHT_RED }} />
        ...
        {stage === "countdown" && (
          ...
          <motion.div key="countdown" className="fixed inset-0 z-[120] flex flex-col items-center justify-center p-6 md:p-12 text-center bg-white/10 backdrop-blur-md">
            ...
            <div style={cardBaseStyles} className="flex flex-col items-center max-w-2xl w-full p-8 md:p-12 rounded-[3.5rem] relative">

              <motion.p initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="romantic-text text-xl md:text-2xl text-gray-800 font-bold italic leading-relaxed mb-6">
              ...
              <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }} className="romantic-text text-lg text-gray-500 italic mb-10">
              ...
              <div className="relative w-24 h-24 flex items-center justify-center mb-4">
                ...
                <span className="text-3xl font-black clean-font" style={{ color: BRIGHT_RED }}>{timer}</span>
              ...
              <AnimatePresence>
                ...
                {timer === 0 && (
                  ...
                  <motion.button
                    ...
                    className="mt-4 p-5 text-white rounded-full shadow-lg hover:scale-105 active:scale-95 transition-all"
        ...
        {stage === "decision" && (
          ...
          <motion.div key="decision" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="fixed inset-0 z-[130] flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              style={{ ...cardBaseStyles, borderRadius: '40px' }}

              className="w-full max-w-lg p-10 md:p-14 text-center shadow-[0_30px_100px_rgba(0,0,0,0.2)]"

            >

              <motion.div animate={{ scale: [1, 1.2, 1] }} transition={{ repeat: Infinity, duration: 2 }} className="mb-8 inline-block">

                <Heart fill={BRIGHT_RED} size={64} style={{ color: BRIGHT_RED }} />

              </motion.div>

              <h1 className="proposal-heading text-4xl md:text-6xl text-gray-900 mb-4 italic leading-tight">I Love You <br/><span style={{ color: BRIGHT_RED }}>Sakshi</span></h1>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <button
                    ...
                    onClick={() => { setStage("success"); notifyDiscord("YES ❤️"); }}

                    style={{ backgroundColor: BRIGHT_RED }}

                    className="group relative py-6 rounded-2xl font-black transition-all active:scale-95 shadow-lg overflow-hidden text-white clean-font text-xl uppercase tracking-widest"
        ...
        {stage === "success" && (
          ...
          <motion.div key="success" className="fixed inset-0 z-[200] flex flex-col items-center justify-center text-center p-8 bg-white/40 backdrop-blur-md">
            ...
            <motion.h1 animate={{ scale: [1, 1.1, 1] }} transition={{ repeat: Infinity }} className="proposal-heading text-7xl font-black mb-10 italic" style={{ color: BRIGHT_RED }}>YAYYY! 🎉</motion.h1>

            <div style={cardBaseStyles} className="p-10 rounded-[2.5rem] max-w-md shadow-2xl">
              ...
              <button onClick={() => setStage("gift")} style={{ backgroundColor: BRIGHT_RED }} className="px-16 py-5 text-white rounded-full font-black shadow-lg transition active:scale-95 clean-font uppercase tracking-widest">Next ➔</button>
        ...
        {stage === "gift" && (
          ...
          <motion.div key="gift" className="fixed inset-0 z-[200] flex items-center justify-center p-6">
            ...
            <div style={{ ...cardBaseStyles, borderTopWidth: '12px', borderTopColor: BRIGHT_RED }} className="w-full max-w-md p-12 rounded-[2.5rem] text-center">

              <h3 className="romantic-text text-xl font-black text-gray-800 mb-10 italic">I have a special gift planned just for you... 🎁</h3>

              <button onClick={() => { notifyDiscord("🎁 GIFT CLAIMED!"); setStage("gift-claimed"); }} style={{ backgroundColor: BRIGHT_RED }} className="flex items-center justify-center gap-3 w-full py-6 text-white rounded-2xl font-black shadow-lg transition active:scale-95 clean-font uppercase tracking-widest">Receive Gift</button>
        ...
        {stage === "gift-claimed" && (
          ...
          <motion.div key="claimed" className="fixed inset-0 z-[200] flex items-center justify-center p-8 text-center bg-white/20 backdrop-blur-xl">
            ...
            <div style={cardBaseStyles} className="p-12 rounded-[2.5rem] max-w-md">

              <Heart size={60} className="mx-auto mb-6 animate-bounce" fill={BRIGHT_RED} style={{ color: BRIGHT_RED }} />
        ...
        {stage === "need-time" && (
          ...
          <motion.div key="time" className="fixed inset-0 z-[200] flex flex-col items-center justify-center p-8 text-center bg-white/20 backdrop-blur-xl">
            ...
            <div style={cardBaseStyles} className="p-12 rounded-3xl shadow-2xl">

               <Timer size={80} className="mb-8 mx-auto" style={{ color: BRIGHT_RED }} />
